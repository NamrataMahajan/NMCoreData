...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    
    {
        if (SegmentControl.selectedSegmentIndex == 0) {
            ...
            cell.label1.text = [Tv valueForKey:@"model"];
            cell.label2.text = [Tv valueForKey:@"name"];
            cell.label3.text = [Tv valueForKey:@"year"];
            ...
            cell.label1.text = [Sp valueForKey:@"name"];
            cell.label2.text = [Sp valueForKey:@"company"];
            cell.label3.text = [Sp valueForKey:@"price"];
        }
        else if (SegmentControl.selectedSegmentIndex == 2)  {
            
            NSManagedObjectContext *Ac = [acArray objectAtIndex:indexPath.row];
            
            cell.label1.text = [Ac valueForKey:@"model"];
            cell.label2.text = [Ac valueForKey:@"price"];
...
-(void)fetchDeviceFromCoreData {
    ...
    if (SegmentControl.selectedSegmentIndex == 0) {
        ...
        NSFetchRequest *fetchRequest = [[NSFetchRequest alloc]initWithEntityName:@"SmartPone"];
